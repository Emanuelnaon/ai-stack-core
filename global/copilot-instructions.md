...
- Para crear UI: Pide `#file:.clinerules/06-skill-ui.md`
- Para un nuevo feature: Pide `#file:.clinerules/07-skill-scaffolding.md`
- Para un formulario (RHF + Zod): Pide `#file:.clinerules/08-skill-formulario.md`
- Para base de datos/Server Actions: Pide `#file:.clinerules/09-skill-migracion.md`